...
#define POLTGON0_TEX "DATA/TEX/blog_20120429_05.jpg"				//読み込むテクスチャファイル名
...
HRESULT CScene3D::Init(void)
{
	...
	pVtx[0].pos = m_pos + D3DXVECTOR3(-2000.0f, 1000.0f, 100.0f);
	pVtx[1].pos = m_pos + D3DXVECTOR3(2000.0f, 1000.0f, 100.0f);
	pVtx[2].pos = m_pos + D3DXVECTOR3(-2000.0f, -800.0f, 100.0f);
	pVtx[3].pos = m_pos + D3DXVECTOR3(2000.0f, -800.0f, 100.0f);
...
D3DXVECTOR3 CScene3D::GetvtxMin(void)
{
	return m_vtxMin;
}

D3DXVECTOR3 CScene3D::GetvtxMax(void)
{
	return m_vtxMax;
}
