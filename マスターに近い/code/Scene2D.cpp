...
// ポジションのセット
//========================================================================================================
void CScene2D::UIUpdate(int nLife, float size_X, float size_Y)
{
	VERTEX_2D *pVtx;
	...
	pVtx[1].pos = D3DXVECTOR3(m_pos.x + (nLife * size_X), m_pos.y, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(m_pos.x, m_pos.y + size_Y, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(m_pos.x + (nLife * size_X), m_pos.y + size_Y, 0.0f);
