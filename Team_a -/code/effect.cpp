...
// マクロ定義
//=============================================================================
#define	EFFECT_01		"DATA/TEX/effect000.jpg"		// 読み込むテクスチャファイル名
#define	EFFECT_02		"DATA/TEX/HitEffect.png"		// 読み込むテクスチャファイル名
...
// 初期化処理
//=============================================================================
HRESULT CEffect::Init(D3DXVECTOR3 pos, D3DXVECTOR3 move, int nLife)
{
...
// エフェクトの作成
//=============================================================================
CEffect * CEffect::Create(D3DXVECTOR3 pos, D3DXVECTOR3 move, int nLife)
{
	CEffect *pEffect = new CEffect(OBJTYPE_EFFECT);
	pEffect->BindTexture(m_pTextureEffect[0]);
	pEffect->Init(pos, move, nLife);
	return pEffect;
}
...
// パーテクル
//=============================================================================
void CEffect::SetParticle(D3DXVECTOR3 pos, D3DXVECTOR3 move, int nLife)
{
	CEffect::Create(D3DXVECTOR3(pos.x,pos.y+50,pos.z), move, nLife);
}
