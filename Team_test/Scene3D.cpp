...
// 前方宣言初期化
//====================================================================================================
DWORD			CScene3D::nNumMat= NULL;						// マテリアル情報の数
LPD3DXMESH		CScene3D::pMesh= NULL;						// メッシュ情報へのポインタ
LPD3DXBUFFER	CScene3D::pBuffMat= NULL;						// マテリアル情報へのポインタ
...
HRESULT CScene3D::Init(void)
{
	...
	pVtx[0].pos = m_PosPolygon + D3DXVECTOR3(-100.0f, 0.0f, 100.0f);
	pVtx[1].pos = m_PosPolygon + D3DXVECTOR3(100.0f, 0.0f, 100.0f);
	pVtx[2].pos = m_PosPolygon + D3DXVECTOR3(-100.0f, 0.0f, -100.0f);
	pVtx[3].pos = m_PosPolygon + D3DXVECTOR3(100.0f, 0.0f, -100.0f);
