...
HRESULT CPolygonBase::Init(void)
{
	...
	pVtx[0].pos = m_pos + D3DXVECTOR3(-1500.0f, 800.0f, 680.0f);
	pVtx[1].pos = m_pos + D3DXVECTOR3(1500.0f, 800.0f, 680.0f);
	pVtx[2].pos = m_pos + D3DXVECTOR3(-1500.0f, -800.0f, 680.0f);
	pVtx[3].pos = m_pos + D3DXVECTOR3(1500.0f, -800.0f, 680.0f);
