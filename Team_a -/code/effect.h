...
public:
	...
	HRESULT Init(D3DXVECTOR3 pos, D3DXVECTOR3 move, int nLife);
	void Uninit(void);
	void Update(void);
	void Draw(void);

	static CEffect *Create(D3DXVECTOR3 pos, D3DXVECTOR3 move, int nLife);
	static HRESULT Load(void);
	static void Unload(void);

	static void SetParticle(D3DXVECTOR3 pos, D3DXVECTOR3 move, int nLife);
